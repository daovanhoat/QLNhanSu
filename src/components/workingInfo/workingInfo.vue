<template>
    <div class="container-workingInfo">
        ...
        <table class="table" style="">
            ...
            <tbody>
                <tr v-for="(workingInfo, index) in workingInfos" :key="workingInfo.workingInfoId" class="tr2">
                    ...
                    <td style="padding: 10px;">{{ new Date(workingInfo.time).toLocaleDateString('vi-VN') }}
                        -
                        {{ workingInfo.endDate ? new Date(workingInfo.endDate).toLocaleDateString('vi-VN') : "Đang làm" }}
                    </td>
